...
ぼくは未だ生まれてもないこんな前の時代に、名曲が創られ、その時代の人たちに聴かれていたと考えると何だか凄いなーと思うしかないです。
...
次の `And I do appreciate you being around` の `around` のところは歌詞を載せているサイトによっては `'round` だったりするのですが、これは先生曰く `around` の省略とのこと。  
